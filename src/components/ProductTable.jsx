...
import { 
  ...
  calculateStockBarWidth, 
  getStockBarColor,
  calculateProductStats
} from '../utils/productTransform'

/**
 * Componente reutilizable para listar productos.
 * Usado por Products.jsx y Almacen.jsx con diferentes configuraciones.
 * 
 * @param {Object} props
 * @param {string} props.title - Título de la página
 * @param {number} props.almacenId - ID del almacén para filtrar productos
 * @param {string} props.newButtonLabel - Texto del botón de nuevo producto
 */
function ProductTable({ title = 'Productos y Ubicaciones', almacenId, newButtonLabel = 'Nuevo Producto' }) {
  ...
  const handleViewProduct = (product) => {
    ...
    setShowPickingRoute(true)
  }

  if (showPickingRoute && selectedProduct) {
    return <PickingRoute
      onBack={() => {
        setShowPickingRoute(false)
        ...
        <div className="products-table">
          ...
          <div className="products-table-body">
            ...
            {loading && (
              <div style={{ 
                ...
                <div style={{ marginBottom: '1rem' }}>Cargando productos...</div>
            ...
            {!loading && !error && products.length === 0 && (
              <div style={{ 
                ...
                <div style={{ marginBottom: '0.5rem', fontWeight: '600' }}>No se encontraron productos</div>
                <div>Intenta cambiar los filtros o el término de búsqueda</div>
              </div>
            )}
                ...
                <div className="product-cell-stock">
                  ...
                  <div className="stock-bar">
                    <div 
                      ...
                      style={{ 
                        width: `${calculateStockBarWidth(product.stock)}%`,
          ...
          <div className="products-pagination">
            <div className="pagination-info">
              Mostrando {products.length > 0 ? ((pagination.page - 1) * pagination.perPage + 1) : 0}-{Math.min(pagination.page * pagination.perPage, pagination.total)} de {pagination.total} productos
            </div>
            <div className="pagination-controls">
              ...
              {pagination.totalPages > 5 && (
                <>
                  ...
                  <button 
                    className={`pagination-button ${pagination.page === pagination.totalPages ? 'active' : ''}`}
